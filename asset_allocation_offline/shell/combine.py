...
hdf = pd.read_csv('highriskposition.csv', index_col = 'date', parse_dates = 'date')
ldf = pd.read_csv('lowriskposition.csv', index_col = 'date', parse_dates = 'date')
hldf = pd.read_csv('highlowriskposition.csv', index_col = 'date', parse_dates = 'date')
...
result_df.to_csv('allposition.csv')
