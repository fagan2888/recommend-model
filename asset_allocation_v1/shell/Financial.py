...
def efficient_frontier_spe(return_rate, bound, day, sum1 = 0.65, sum2 = 0.45):
    ...
    sh300_mean = sh300_mean.rolling(120).mean()
    zz500_mean = zz500_mean.rolling(120).mean()
    sp500_mean = sp500_mean.rolling(120).mean()
    hsi_mean = hsi_mean.rolling(120).mean()
    gold_mean = gold_mean.rolling(120).mean()
    asset_mean = [
