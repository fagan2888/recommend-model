...
class Policy(object):    
    ...
    def place_buy_order(self, ts_order):
        df_ts_order_fund = self.df_ts_order_fund.loc[(ts_order['ts_txn_id'], ts_order['ts_placed_date'], (30, 31, 63)), :]
        return {'ts_order_fund':df_ts_order_fund, 'plan':{}}
