...
def all_stock_market_value():
    ...
    stock_df.to_csv('./data/stock_market_value.csv')


#所有股票的收盘价
def all_stock_market_value_update():

    stock_df = pd.read_csv('./data/stock_market_value.csv', index_col = 'date', parse_dates = ['date'])
...
if __name__ == '__main__':
    #all_stock_market_value_update()
    all_stock_market_value()
    print 'update market value done'
