    ...
    if assets:
        ...
        if short_cut == 'high':
            assets = {
                ...
                #120000010:  {'sum1': 0, 'sum2' : 0,    'upper': 0.60, 'lower': 0.35}, #中证全风险5
                #120000010:  {'sum1': 0, 'sum2' : 0,    'upper': 0.52, 'lower': 0.28}, #中证全风险6
            ...
            assets = {
                ...
                #120000028:  {'sum1': 0, 'sum2' : 0,'upper': 1.0, 'lower': 0.0}, #标普高盛原油商品指数收益率
                #120000031:  {'sum1': 0, 'sum2' : 0,'upper': 1.0, 'lower': 0.0}, #房地产指数

                #120000016:  {'sum1': 0,    'sum2' : 0,   'upper': 1.0,  'lower': 0.0}, #上证指数
                #120000025:  {'sum1': 0, 'sum2' : 0,'upper': 1.0, 'lower': 0.0}, #德国DAX
                120000041:  {'sum1': 0, 'sum2' : 0,'upper': 1.0, 'lower': 0.0}, #黄金指数修型
                #120000020:  {'sum1': 0, 'sum2' : 0,'upper': 1.0, 'lower': 0.0}, #纳斯达克指数
            }
