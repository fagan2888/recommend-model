    ...
    if assets:
        ...
        if short_cut == 'high':
            assets = {
                ...
                120000001:  {'sum1': 0,    'sum2' : 0,   'upper': 0.70,  'lower': 0.0}, #沪深300指数修型
                120000002:  {'sum1': 0,    'sum2' : 0,   'upper': 0.70,  'lower': 0.0}, #中证500指数修型
                120000013:  {'sum1': 0.0, 'sum2' : 0,   'upper': 0.50, 'lower': 0.0}, #标普500指数
                120000015:  {'sum1': 0.0, 'sum2' : 0,   'upper': 0.50, 'lower': 0.0}, #恒生指数修型
                120000014:  {'sum1': 0.0, 'sum2' : 0.0,'upper': 0.50, 'lower': 0.0}, #黄金指数修型
            }
            if optname is None:
