    ...
    if assets:
        ...
        if short_cut == 'high':
            assets = {
                ...
                30000593:  {'sum1': 0,    'sum2' : 0,   'upper': 0.70,  'lower': 0.0}, #160505,博时主题行业混合LOF
                30000596:  {'sum1': 0,    'sum2' : 0,   'upper': 0.70,  'lower': 0.0}, #160311,华夏蓝筹混合LOF
                30000605:  {'sum1': 0,    'sum2' : 0,   'upper': 0.70,  'lower': 0.0}, #160211,国泰中小盘成长混合LOF
                30000610:  {'sum1': 0,    'sum2' : 0,   'upper': 0.70,  'lower': 0.0}, #162711,广发中证500ETF联接(LOF)A
                30000634:  {'sum1': 0,    'sum2' : 0,   'upper': 0.70,  'lower': 0.0}, #166007,中欧沪深300指数增强LOFA
                30000658:  {'sum1': 0,    'sum2' : 0,   'upper': 0.70,  'lower': 0.0}, #160212,国泰估值优势混合LOF
                30000685:  {'sum1': 0,    'sum2' : 0,   'upper': 0.70,  'lower': 0.0}, #160716,嘉实基本面50指数LOF
                30002834:  {'sum1': 0,    'sum2' : 0,   'upper': 0.70,  'lower': 0.0}, #050018,博时行业轮动混合
                30000366:  {'sum1': 0,    'sum2' : 0,   'upper': 0.70,  'lower': 0.0}, #096001,大成标普500等权重QDII
                30003039:  {'sum1': 0,    'sum2' : 0,   'upper': 0.70,  'lower': 0.0}, #519983,长信量化先锋混合A
