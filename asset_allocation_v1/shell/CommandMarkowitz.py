    ...
    if assets:
        ...
        if short_cut == 'high':
            assets = {
                ...
                120000013:  {'sum1': 0.65, 'sum2' : 0,   'upper': 0.70, 'lower': 0.0}, #标普500指数
                120000015:  {'sum1': 0.65, 'sum2' : 0,   'upper': 0.70, 'lower': 0.0}, #恒生指数修型
                120000014:  {'sum1': 0.65, 'sum2' : 0.45,'upper': 0.70, 'lower': 0.0}, #黄金指数修型
