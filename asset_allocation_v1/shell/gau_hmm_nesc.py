...
class HmmNesc(object):
    ...
    def __init__(self, file_handle):
        ...
        # 特征集"SI", "SRMI",
        # 恒生
        self.features = ["pct_chg", "high", "PRICEOSC", "slowKD", "ROC", \
                        "MTM", "DPO", "ATR", "CCI", "RSI", "BIAS"]
        # 非A股
        self.features = ["pct_chg", "high", "PVT", "WVAD", "PRICEOSC", \
                        "slowKD", "ROC", "MTM", "DPO", "ATR", "CCI", "RSI", \
                        "BIAS", "vol_ratio", "VMA", "VSTD", "SOBV", "VMACD"]
        # A股
        self.features = ["pct_chg", "high", "PVT", "WVAD", "PRICEOSC", \
                        "slowKD", "ROC", "MTM", "DPO", "ATR", "CCI", "RSI", \
                        "TAPI", "BIAS", "vol_ratio", "VMA", "VSTD", "SOBV", "VMACD"]
        # 训练开始时间
