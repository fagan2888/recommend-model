...
def match_asset_pool(gid):
    ...
    if xtype == 1:
        ...
        zheshang_or_boshi = 'zheshang'
        with open('shell/asset_zheshang_boshi', 'r') as f:
            zheshang_or_boshi = f.readline().strip()

        if 'zheshang' == zheshang_or_boshi:
            xtab = {
                '120000001': 11110103, # 沪深300, 大盘池
                '120000002': 11110203, # 中证500, 小盘池
                '120000011': 11210203, # 中证信用债指数，信用债池
                '120000014': 11400101, # 沪金指数, 黄金池
                '120000013': 11120202, # 标普500人民币计价指数, 标普基金池
                '120000015': 11120502, # 恒生指数人民币计价指数, 恒生基金池
            }
        elif 'boshi' == zheshang_or_boshi:

            xtab = {
                '120000001': 11110101, # 沪深300, 大盘池
                '120000002': 11110201, # 中证500, 小盘池
                '120000011': 11210201, # 中证信用债指数，信用债池
                '120000014': 11400102, # 沪金指数, 黄金池
                '120000013': 11120203, # 标普500人民币计价指数, 标普基金池
                '120000015': 11120503, # 恒生指数人民币计价指数, 恒生基金池
            }
