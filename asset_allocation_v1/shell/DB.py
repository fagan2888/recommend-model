...
def label_asset(allocationdata):
    ...
    label_asset_df.to_csv('/home/data/kun/wwwroot/recommend_model/asset_allocation_v1/tmp/test.csv')
...
def riskhighlowriskasset(allocationdata):
    ...
    df = pd.read_csv('/home/data/kun/wwwroot/recommend_model/asset_allocation_v1/tmp/risk_portfolio.csv', index_col = 'date', parse_dates = ['date'])
    ...
    for risk_rank in allriskposition.keys():
...
if __name__ == '__main__':
    ...
    df = pd.read_csv('/home/data/kun/wwwroot/recommend_model/asset_allocation_v1/tmp/stock_indicator_2015-07-10.csv', index_col = 'code')
    allocationdata.stock_fund_measure['2015-07-10'] = df
    df = pd.read_csv('/home/data/kun/wwwroot/recommend_model/asset_allocation_v1/tmp/stock_label_2015-07-10.csv', index_col = 'code')
    allocationdata.stock_fund_label['2015-07-10'] = df
    fund_measure(allocationdata)


    df = pd.read_csv('/home/data/kun/wwwroot/recommend_model/asset_allocation_v1/tmp/labelasset.csv', index_col = 'date')
    allocationdata.label_asset_df = df
    df = pd.read_csv('/home/data/kun/wwwroot/recommend_model/asset_allocation_v1/tmp/stock_fund.csv', index_col = 'date')
    allocationdata.stock_fund_df  = df
    df = pd.read_csv('/home/data/kun/wwwroot/recommend_model/asset_allocation_v1/tmp/equalriskasset.csv', index_col = 'date')
    allocationdata.equal_risk_asset_df  = df
    df = pd.read_csv('/home/data/kun/wwwroot/recommend_model/asset_allocation_v1/tmp/equalriskassetratio.csv', index_col = 'date')
    allocationdata.equal_risk_asset_ratio_df  = df
    df = pd.read_csv('/home/data/kun/wwwroot/recommend_model/asset_allocation_v1/tmp/bond_fund.csv', index_col = 'date')
    ...
    df = pd.read_csv('/home/data/kun/wwwroot/recommend_model/asset_allocation_v1/tmp/highriskasset.csv', index_col = 'date')
    allocationdata.high_risk_asset_df = df
    df = pd.read_csv('/home/data/kun/wwwroot/recommend_model/asset_allocation_v1/tmp/lowriskasset.csv', index_col = 'date')
    allocationdata.low_risk_asset_df = df
    df = pd.read_csv('/home/data/kun/wwwroot/recommend_model/asset_allocation_v1/tmp/highlowriskasset.csv', index_col = 'date')
    allocationdata.highlow_risk_asset_df = df
    df = pd.read_csv('/home/data/kun/wwwroot/recommend_model/asset_allocation_v1/tmp/highriskposition.csv', index_col = 'date')
    allocationdata.high_risk_position_df = df
    df = pd.read_csv('/home/data/kun/wwwroot/recommend_model/asset_allocation_v1/tmp/lowriskposition.csv', index_col = 'date')
    allocationdata.low_risk_position_df = df
    df = pd.read_csv('/home/data/kun/wwwroot/recommend_model/asset_allocation_v1/tmp/highlowriskposition.csv', index_col = 'date')
