...
def factor_exposure_update(ctx):
    ...
    # for _ff in ffs:
    #     t = datetime.now()
    #     _ff.cal_factor_exposure()
    #     print(_ff.factor_id, 'cal factor exposure done')
    #     asset_fund_factor.update_exposure(_sf)
...
def factor_return_update(ctx):
    ...
    ffs = ffs1 + ffs2
    ff = FundFactor()
    df_ret, df_sret = ff.cal_factor_return(ffs1)
