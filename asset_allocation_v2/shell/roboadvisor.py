...
import CommandFinIndicator
import CommandLowRankBond
...
if __name__=='__main__':
    ...
    roboadvisor.add_command(CommandFinIndicator.indicator)
    roboadvisor.add_command(CommandLowRankBond.bond)
    roboadvisor(obj={})
