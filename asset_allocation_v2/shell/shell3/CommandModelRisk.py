...
@click.command()
@click.option('--inst', 'optinst', type=int, default=None, help='instance id')
@click.option('--type', 'opttype', type=int, default=1, help='instance type(1:experimental;9:online)')
...
@click.option('--exclude-category', 'excluded_category', help='category to excluded(e.g. rise,decline,SP500.SPI,GLNC,HSCI.HI')
@click.pass_context
