...
@export.command()
@click.option('--inst', 'optinst', help='portfolio to exprot (e.g. 2016120700:10,20161207:5)')
@click.option('--index', 'optindex', help='index to export (e.g. 120000001,120000002)')
@click.option('--composite', 'optcomposite', help='composite asset to export (e.g. 20001,2002)')
@click.option('--fund', 'optfund', help='fund to export (e.g. 20001,2002)')
@click.option('--fund-type', 'optfundtype', default = None, help='fund type to export (e.g. 1)')
@click.option('--pool', 'optpool', help='fund pool to export (e.g. 921001:0,92101:11)')
@click.option('--online', 'optonline', help='online model')
@click.option('--online2', 'optonline2', help='new online model')
@click.option('--highlow', 'opthighlow', help='highlow to export(e.g. 70052400,70052401)')
@click.option('--portfolio', 'optportfolio', help='portfolio to export(e.g. 80052400:9)')
@click.option('--timing', 'opttiming', help='timing to export(e.g. 21400501:8)')
@click.option('--list/--no-list', 'optlist', default=False, help='list pool to update')
@click.option('--start-date', 'optstartdate', default='2012-07-27', help='start date to calc')
@click.option('--end-date', 'optenddate', help='end date to calc')
# @click.option('--tools', '-t', type=click.Choice(['tool1', 'tool2', 'tool3']), multiple=True)
@click.option('--datetype', 'optdatetype', type=click.Choice(['t', 'n']), default='t', help='date type(t: trade date; n: nature date)')
...
@export.command()
@click.option('--list/--no-list', 'optlist', default=False, help='list pool to update')
@click.option('--start-id', 'optstartid', help='start investor id to export')
@click.option('--end-id', 'optendid', help='end investor id to export')
@click.option('--month/--no-month', 'optmonth', default=True, help='month return for investor')
# @click.option('--tools', '-t', type=click.Choice(['tool1', 'tool2', 'tool3']), multiple=True)
@click.option('--output', '-o', type=click.Path(), help='output file')
@click.pass_context
