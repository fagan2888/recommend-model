...
from db import database, asset_mz_markowitz, asset_mz_markowitz_alloc, asset_mz_markowitz_argv,  asset_mz_markowitz_asset, asset_mz_markowitz_criteria, asset_mz_markowitz_nav, asset_mz_markowitz_pos, asset_mz_markowitz_sharpe, asset_wt_filter_nav, asset_ra_portfolio_nav
        ...
        if prefix.isdigit():
            ...
            if prefix == 'AP':
                ...
                sr = db.asset_ra_portfolio_nav.load_series(
                    asset_id, 9, reindex=reindex, begin_date=begin_date, end_date=end_date)
            else:
                sr = pd.Series()
