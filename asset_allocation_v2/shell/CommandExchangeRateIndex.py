...
@exrindex.command()
@click.option('--full/--no-full', 'optfull', default=True, help='include all instance')
@click.option('--id', 'optid', help='specify cnyindex id')
@click.pass_context
    ...
    with click.progressbar(records) as bar:
            for record in bar:
                ...
                if exchange_rate_index_nav_df['eri_index_id'].iloc[0] == 'ERI000001':
                    ...
                    ra_index_nav_df['ra_index_id'] = 120000082
