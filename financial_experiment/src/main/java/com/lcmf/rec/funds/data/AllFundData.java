...
public class AllFundData {
	...
	public List<String> typeFund(String start_date_str, String end_date_str, int type) throws SQLException, ParseException{
		...
		fi_reader.connect(FundInfoReaer.host, FundInfoReaer.port, FundInfoReaer.database, FundInfoReaer.username, FundInfoReaer.password);
