...
portfolio_base_sql = "insert into portfolios (p_name, p_risk, pf_date, pf_position_reason,pf_focus, pf_position_record, pf_annual_returns, pf_expect_returns_max, pf_expect_returns_min, created_at, updated_at) values ('%s', '%f', '%s','%s' ,'%s', '%s', '%f', '%f', '%f', '%s', '%s')"
