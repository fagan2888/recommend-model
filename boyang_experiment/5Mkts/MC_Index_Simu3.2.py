...
##########################################################################
'A-share (3d-21d) testing'

#start_lag_days=2
#Index_backtesting_Indicator_1D = pd.DataFrame(data=Index_backtesting_Indicator.values, columns=Index_backtesting_Indicator.columns, index=Index_backtesting_Indicator.index + timedelta(days=start_lag_days))
