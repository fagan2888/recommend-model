# -*- coding: utf-8 -*-
"""
Created on Tue Oct 23 19:31:57 2018
...
def run_chain(chainer, f, proposal, start, n, take=1):
    ...
    For a given target distribution p ∗ , a proposal distribution q is valid or admissible if it gives a non-zero probability of moving to the states that have non-zero probability in the target.
